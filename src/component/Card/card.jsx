...
const Card = (props) => {
    return (
        // <>
        //     <div className="py-5 px-2"> {/* Fixed padding class 'p-' */}
        //         <img src={props.image} alt="Product" className="" /> {/* Corrected 'img' to 'image' */}
        //         <p className="font-[poppins] font-semibold text-lg">{props.title}</p>
        //         <p>{props.content}</p> {/* Fixed content access */}
        //         <p>{props.description}</p>
        //         <p className="font-[poppins] font-semibold text-lg py-5 px-5">{props.price}</p>
